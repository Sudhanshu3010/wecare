...
const Texto = () => {
  return (
   ...
   <p class="text-[#FF7918] font-bold text-xl md:text-2xl text-center">"How WeCare Works.."</p>
   ...
   pick-up services in a few clicks. Our data-driven technology provides <br />
